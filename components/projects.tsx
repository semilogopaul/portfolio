...
const projects = [
  ...
  },
  {
    ...
    stack: ["PYTHON", "DJANGO", "DJANGO-REST FRAMEWORK", "SQL", "HTML", "CSS", "JAVASCRIPT", "DJOSER"],
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    title: "DIY Analytics",
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.stack.slice(0, 3).map((tech: string) => (
            <Badge key={tech} variant="secondary" className="text-xs bg-blue-900/50 text-blue-200 hover:bg-blue-800">
              {tech}
            </Badge>
          ))}
